...
const ICON_MAP = {
  Heart, TrendingUp, Users, Smile, Star, Zap, Shield, Award,
}
...
const FALLBACK_BENEFITS = [
  {
    ...
    description: 'Ein täglicher Essenszuschuss gehört zu den beliebtesten Benefits. Mit Lunchit ist er digital, flexibel und sofort einsetzbar.',
  },
  {
    iconName: 'TrendingUp',
  ...
  },
  {
    ...
    description: 'Regelmäßige Wertschätzung senkt die Fluktuation. Lunchit ist das kleine Plus, das einen großen Unterschied macht.',
  },
  {
    iconName: 'Smile',
    title: 'Einfach im HR-Alltag',
    description: 'Keine Papierbelege, kein Aufwand. Lunchit integriert sich nahtlos in bestehende HR-Prozesse und Abrechnungssysteme.',
  },
]

export default function Purpose({
  eyebrow = 'Warum Lunchit?',
  headline = 'Mehr als ein Benefit – ein echtes Zeichen',
  subtext = 'Lunchit by Spendit ist der smarte Weg, Mitarbeiterzufriedenheit zu steigern – steueroptimiert, digital und einfach zu verwalten.',
